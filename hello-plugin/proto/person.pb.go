...
func (x *RequestPerson) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
type RequestAddressBook struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
}

func (x *RequestAddressBook) Reset() {
	*x = RequestAddressBook{}
	if protoimpl.UnsafeEnabled {
...
func (x *RequestAddressBook) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RequestAddressBook) ProtoMessage() {}

func (x *RequestAddressBook) ProtoReflect() protoreflect.Message {
	mi := &file_person_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RequestAddressBook.ProtoReflect.Descriptor instead.
func (*RequestAddressBook) Descriptor() ([]byte, []int) {
...
var file_person_proto_rawDesc = []byte{
	...
	0x61, 0x6d, 0x70, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x23, 0x0a, 0x0d, 0x52, 0x65, 0x71,
	0x75, 0x65, 0x73, 0x74, 0x50, 0x65, 0x72, 0x73, 0x6f, 0x6e, 0x12, 0x12, 0x0a, 0x04, 0x6e, 0x61,
	...
	0x42, 0x6f, 0x6f, 0x6b, 0x22, 0xbb, 0x02, 0x0a, 0x06, 0x50, 0x65, 0x72, 0x73, 0x6f, 0x6e, 0x12,
	...
	,
...
var file_person_proto_goTypes = []interface{}{
	...
	(*RequestPerson)(nil),         // 1: tutorial.RequestPerson
	(*RequestAddressBook)(nil),    // 2: tutorial.RequestAddressBook
...
var file_person_proto_depIdxs = []int32{
	...
	1, // 4: tutorial.HelloPlugin.GetPerson:input_type -> tutorial.RequestPerson
	2, // 5: tutorial.HelloPlugin.GetAddressBook:input_type -> tutorial.RequestAddressBook
	3, // 6: tutorial.HelloPlugin.GetPerson:output_type -> tutorial.Person
	4, // 7: tutorial.HelloPlugin.GetAddressBook:output_type -> tutorial.AddressBook
...
func file_person_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_person_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*RequestAddressBook); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
